...
<br><br>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators">
                        @foreach ($slides1 as $item)

                        <li data-target="#carouselExampleIndicators" data-slide-to="{{ $item->position-1 }}" class="active"></li>
                        @endforeach
                    ...
                    @foreach ($slides1 as $item)
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img class="d-block w-100" src="assets/uploads/slide-images/{{$item->image }}" alt="slide {{ $item->position }}">
...
<div class="content">
    ...
    <div class="container">
        <div class="title-wrapper container"> <h2 class="container !important">Featured Categories</h2></div>
    </div>
...
<div class="container">
    ...
    @if ($count>$paginate_options->home_n_articles)
    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{ url('/new-products') }}">View More</a></div>
    @endif
